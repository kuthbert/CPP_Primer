...
${OBJECTDIR}/Classes/Class_Objects.o: Classes/Class_Objects.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Class_Objects.o Classes/Class_Objects.cpp

${OBJECTDIR}/Classes/ConstRef.o: Classes/ConstRef.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/ConstRef.o Classes/ConstRef.cpp

${OBJECTDIR}/Classes/Record.o: Classes/Record.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Record.o Classes/Record.cpp

${OBJECTDIR}/Classes/Sales_item.o: Classes/Sales_item.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Sales_item.o Classes/Sales_item.cpp
...
${OBJECTDIR}/Classes/Test_Classes.o: Classes/Test_Classes.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Test_Classes.o Classes/Test_Classes.cpp

${OBJECTDIR}/Study_Class_Main.o: Study_Class_Main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Study_Class_Main.o Study_Class_Main.cpp
